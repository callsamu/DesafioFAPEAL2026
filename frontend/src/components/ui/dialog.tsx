    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close
          ...
          className="absolute top-3 right-3 rounded-sm opacity-70 transition-opacity outline-none hover:opacity-100 focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none"
        >
